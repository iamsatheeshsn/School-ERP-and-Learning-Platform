...
export const NAVIGATION: Record<Role, NavItem[]> = {
  [Role.ADMIN]: [
    ...
    { title: "Exams", href: prefix(Role.ADMIN, "/exams"), icon: ClipboardList },
    { title: "Library", href: prefix(Role.ADMIN, "/library"), icon: Library },
    { title: "Transport", href: prefix(Role.ADMIN, "/transport"), icon: Bus },
    { title: "Staff leave", href: prefix(Role.ADMIN, "/leave"), icon: CalendarClock },
  ...
  [Role.TEACHER]: [
    ...
    { title: "Exams", href: prefix(Role.TEACHER, "/exams"), icon: ClipboardList },
    { title: "Leave", href: prefix(Role.TEACHER, "/leave"), icon: CalendarClock },
  ...
  [Role.PARENT]: [
    ...
    { title: "Exams", href: prefix(Role.PARENT, "/exams"), icon: ClipboardList },
    { title: "Library", href: prefix(Role.PARENT, "/library"), icon: Library },
    { title: "Transport", href: prefix(Role.PARENT, "/transport"), icon: Bus },
  ...
  [Role.STUDENT]: [
    ...
    { title: "Exams", href: prefix(Role.STUDENT, "/exams"), icon: ClipboardList },
    { title: "Library", href: prefix(Role.STUDENT, "/library"), icon: Library },
    { title: "Transport", href: prefix(Role.STUDENT, "/transport"), icon: Bus },
